...
export default class extends BaseComponent {
  ...
  render() {
      ...
      console.log('new Date():',new Date((new Date().getTime() - (5 * 24*60*60*1000))).toLocaleString())
              ...
              <Header>
                  <Form>
                      <Row gutter={16}>
                          <Col span={6}>
                              <Form.Item label="日期：" name="size">
                                  <RangePicker
                                      defaultValue={[moment(new Date((new Date().getTime() - (5 * 24*60*60*1000))).toLocaleString(), dateFormat), moment(new Date(), dateFormat)]}
                      ...
                      <Row gutter={16}>
                          ...
                          <Button type="default" className={style.btnAction} onClick={()=>{this.onExport()}}>导出</Button>
                      </Row>
