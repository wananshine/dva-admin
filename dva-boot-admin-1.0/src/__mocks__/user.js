import RightsManage from "../routes/SystemSettings/RightsManage";
import CRUD from "../routes/Business/CRUD";
...
export default ({fetchMock, delay, mock, toSuccess, toError}) => {
  ...
  // fetchMock.mock(/httpbin.org\/post/, {/* response */}, {/* CRUD(app) */});
