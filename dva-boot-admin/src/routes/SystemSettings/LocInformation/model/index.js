...
export default modelEnhance({
    ...
    effects: {
        ...
        *save({ payload }, { call, put, select, take }) {
            ...
            const res = yield select(state => state.LocInformation);
            yield put({
                type: 'getPageInfo',
                payload: res
            });
        ...
        *remove({ payload }, { call, put, select }) {
            ...
            // const response = yield select(state => state.LocInformation);
            // yield put({
            //     type: '@request',
            //     payload: {
            //         notice: true,
